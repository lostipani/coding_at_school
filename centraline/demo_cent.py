"""
Examples with data from centraline sensor.community
"""

import centraline as cnt


#------------------------------------------------------------
### 0) fetch data in given date range

lsgal = cnt.centraline(start='2022-06-10', end='2022-06-24')
...
lsgal.filter(['2022-06-18','2022-06-20'], hour=[6,10])["P1"].plot()
plt.show()
...
lsgal.plot(date=['2022-06-18','2022-06-18'], ma=0)
lsgal.plot(date=['2022-06-18','2022-06-18'], ma=20)
...
mydf = lsgal.filter(date=['','2022-06-18']) # dates: from first of dataset to 2022-06-18
y1 = cnt.smooth(mydf["P1"], 10) # smoothing of filtered data
y2 = cnt.smooth(mydf["P2"], 10)
